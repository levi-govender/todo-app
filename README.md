...
- **Scalable:** refresh keeps the list in a separate IndexedDB; the list is index-paged (50 at a time).
...
1. Dedicated search strategy at 10k+ (prefix/index vs contains scan)
